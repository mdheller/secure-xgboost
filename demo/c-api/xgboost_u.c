    ...
    size_t* remote_report_size)
{
    ...
    /* Marshalling struct. */
    enclave_get_remote_report_with_pubkey_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_get_remote_report_with_pubkey_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_get_remote_report_with_pubkey_args_t));
    if (pem_key)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_get_remote_report_with_pubkey_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             xgboost_fcn_id_enclave_get_remote_report_with_pubkey,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_get_remote_report_with_pubkey_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    size_t remote_report_size)
{
    ...
    /* Marshalling struct. */
    enclave_verify_remote_report_and_set_pubkey_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_verify_remote_report_and_set_pubkey_args_t));
    if (pem_key)
    ...
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_verify_remote_report_and_set_pubkey_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_verify_remote_report_and_set_pubkey_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (pem_key)
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             xgboost_fcn_id_enclave_verify_remote_report_and_set_pubkey,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_verify_remote_report_and_set_pubkey_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
